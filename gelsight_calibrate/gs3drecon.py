...
class Reconstruction3D:
    ...
    def __init__(
        ...
        """
        :param calib_dir: str; the directory to save the callibration data.
        ...
        # Load the gxy model
        gxy_model_path = osp.join(calib_dir, gxy_mode + "_gxy_model", "nnmini.pth")
        ...
        # self.gxy_net = torch.load(gxy_model_path, map_location=self.device)
        self.gxy_net.eval()
    ...
    def get_surface_info(self, image, ppmm, mask_markers=False, cm=None):
        """
